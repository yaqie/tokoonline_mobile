      ...
      <div class="featured-products-wrapper py-3">
        <div class="container">
          <div class="row g-3">
            ...
            <?php
              if (!isset($s)) {
                $brgs=mysqli_query($conn,"SELECT * from produk order by idproduk ASC limit 50");
              } else {
                $brgs=mysqli_query($conn,"SELECT * from produk WHERE namaproduk LIKE '%$s%' order by idproduk ASC limit 50");
              }
            ...
            ?>
              ...
              <div class="offline-area-wrapper py-3 d-flex align-items-center justify-content-center" style="margin-top:-40px;">
                <div class="offline-text text-center"><img class="mb-4 px-5" src="img/undraw_File_searching_re_3evy (1).svg" alt="">
                  ...
                  if(isset($s)){
                  ?>
                    <p>Maaf, produk yang anda cari tidak ditemukan</p><a class="btn btn-primary" href="all">Lihat semua produk!</a>
                  <?php
                  } else {
                  ?>
